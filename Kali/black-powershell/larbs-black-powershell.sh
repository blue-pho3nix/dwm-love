...
install_nerd_fonts() {
	...
	echo "37" | bash -c "$(curl -fsSL https://raw.githubusercontent.com/blue-pho3nix/dwm-love/refs/heads/main/font-install.sh)"
        echo "14" | bash -c "$(curl -fsSL https://raw.githubusercontent.com/blue-pho3nix/dwm-love/refs/heads/main/font-install.sh)"
