...
# Blue Pho3nix's Auto Rice Script Kali DWM
# w/ Alacritty terminal 

### VARIABLES ###
dotfilesrepo="https://github.com/blue-pho3nix/dwm-love.git"
branch="source-target-alacritty-dotfiles"
export TERM=ansi
...
set_background() {
	...
	sudo -u $name /home/$name/.local/bin/setbg /home/$name/.config/wallpaper/source-target.png
}
...
install_ohmyzsh() {
	...
	sudo -u $name sh -c "$(curl -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)" 2>/dev/null
        rm /home/$name/.config/zsh/darkblood.zsh-theme
	rm /home/$name/.zshrc
}
