...
static char normbgcolor[]           = "#0a0a0d"; // Exterior BG
static char normbordercolor[]       = "#0a0a0d";
static char normfgcolor[]           = "#f6eff6";
static char selfgcolor[]            = "#46e6fe";
static char selbordercolor[]        = "#a2f766";
static char selbgcolor[]            = "#0a0a0d";
...
*/
    ...
    { ALTMOD,           XK_r,          spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "lfub", NULL } } },
