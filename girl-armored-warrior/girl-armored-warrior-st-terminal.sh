...
branch="girl-armored-warrior-st-dotfiles"
export TERM=ansi
...
set_background() {
	...
	sudo -u $name /home/$name/.local/bin/setbg /home/$name/.config/wallpaper/girl-armored-warrior.png
}
...
install_ohmyzsh() {
	...
	mv /home/$name/.config/zsh/.zshrc /home/$name/.zshrc
        rm /home/$name/.oh-my-zsh/themes/josh.zsh-theme
        mv /home/$name/.config/zsh/josh.zsh-theme /home/$name/.oh-my-zsh/themes/josh.zsh-theme
}
