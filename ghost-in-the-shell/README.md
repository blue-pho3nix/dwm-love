...
```
wget https://raw.githubusercontent.com/blue-pho3nix/dwm-love/refs/heads/add-gits/ghost-in-the-shell/ghost-in-the-shell-alacritty-terminal.sh && sudo bash ghost-in-the-shell-alacritty-terminal.sh
```
