...
branch="nefelibata-alacritty-dotfiles"
export TERM=ansi
...
set_background() {
	...
	sudo -u $name /home/$name/.local/bin/setbg /home/$name/.config/wallpaper/nefelibata.png
}
