...
> [!Note]
> If you get an errors while installing, try using `kali-tweaks` to change to `Network Repositories` > `Mirrors: Cloudflare`.
...
```
wget https://raw.githubusercontent.com/blue-pho3nix/dwm-love/refs/heads/main/nefelibata/nefelibata-alacritty-terminal.sh && sudo bash nefelibata-alacritty-terminal.sh
```
...
- [dotfiles](https://github.com/blue-pho3nix/dwm-love/tree/nefelibata-alacritty-dotfiles)

```
git clone -b nefelibata-alacritty-dotfiles https://github.com/blue-pho3nix/dwm-love.git
```
